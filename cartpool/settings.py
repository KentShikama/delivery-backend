"""
Django settings for cartpool project.
...
SECRET_KEY = '_!*b6_0uiprpva2+d5c-^--y-&r17+vlf-^y7zf*d-z5d-m148'
...
WSGI_APPLICATION = 'cartpool.wsgi.application'
